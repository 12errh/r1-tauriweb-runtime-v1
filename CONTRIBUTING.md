...
R1 is at v0.3 (Phase 5 complete) and the most valuable thing you can do right now is **test it with your own Tauri app** and report what breaks. v0.3 added SQLite support, automatic migration via `npx r1 sync` CLI, comprehensive WASI shim implementation, and the `#[r1::command]` proc macro for automatic serialization.
