# R1 TauriWeb Runtime — AI Agent Guide (v0.3.6)
...
**v0.3.6** — Production ready, all packages published, E2E tested against Tauri v2
...
- `@r1-runtime/cli` **v0.3.6** ← use this version
