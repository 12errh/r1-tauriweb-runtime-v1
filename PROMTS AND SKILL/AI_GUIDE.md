# R1 TauriWeb Runtime — AI Agent Guide (v0.3.3)
...
**v0.3.3** — Production ready, all packages published, E2E tested against Tauri v2
...
- `@r1-runtime/vite-plugin` **v0.3.3** ← use this version
- `@r1-runtime/cli` **v0.3.3** ← use this version
