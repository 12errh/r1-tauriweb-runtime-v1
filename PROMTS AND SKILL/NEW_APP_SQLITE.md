# R1 New App with SQLite Prompt (v0.3.1)
...
```
You are building a new application with R1 TauriWeb Runtime v0.3.1 that uses SQLite for data persistence.
